...
bash call_scripts/train_nat.sh -e F-2-1-1-H12-UD25M --twcc --fp16 -g 1 --save-interval-updates 32500 --max-update 200000 --lm-start-step 130000 --max-tokens 3276 -b 65520 --no-atten-mask
