source $HOME/.bashrc 
conda activate base
bash call_scripts/train_nat.sh -e E-2-1-1-H12-UR40M --fp16 -g 4 --save-interval-updates 32500 --max-update 130000 --lm-start-step 130000 --max-tokens 2048 -b 65536 --no-atten-mask --watch-test-bleu
...
bash call_scripts/train_nat.sh -e E-2-1-1-H12-UR40M --fp16 -g 4 --save-interval-updates 32500 --max-update 200000 --lm-start-step 130000 --max-tokens 2048 -b 65536 --no-atten-mask --watch-test-bleu
