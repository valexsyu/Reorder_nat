...
bash call_scripts/train_nat.sh -e  J-2-1-1-H12-UR40M --fp16 -g 1 --save-interval-updates 70000 --max-update 100000 --lm-start-step 75000 --max-tokens 4096 -b 12288 --no-atten-mask 
bash call_scripts/train_nat.sh -e  4-2-1-1-H12-UD25M --fp16 -g 1 --save-interval-updates 70000 --max-update 100000 --lm-start-step 75000 --max-tokens 4096 -b 12288 --no-atten-mask 
