...
experiment=J-6-4-1-H12-UF20M-ship
bash call_scripts/train_nat.sh -e $experiment --fp16 --save-interval-updates 70000 --max-update 100000 \
                            --max-tokens 3072 -b 12288 -g 1 --dropout 0.1 --no-atten-mask
