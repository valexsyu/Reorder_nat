...
DATABIN=data/nat_position_reorder/awesome/Bibert_token_distill_wmt14_de_en_52k/de-en-databin
BATCH_SIZE=30
...
# -----------    Setting    -------------
CHECKPOINTS=("No-2-1-2-reorder-translation" "No-2-1-4-reorder-translation-lm")
# REORDER_TRANSLATION=translation
REORDER_TRANSLATION=reorder_translation
