#---------Path Setting-------------------#
CHECKPOINT=checkpoints/No-2-1-3-400000-translation-lm
DATA_BIN=data/nat_position_reorder/awesome/Bibert_token_distill_wmt14_de_en_52k/de-en-databin
MAX_TOKENS=4096
MAX_EPOCH=400
CUR_START_EPOCH=300
CUDA_DEVICES=0
