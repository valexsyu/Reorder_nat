...
# -----------    Setting    -------------
CHECKPOINTS=("No-1-3-1-translation")
...
PRE_SRC=/home/valexsyu/Doc/NMT/Reorder_nat/data/nat_position_reorder/awesome/Bibert_token_distill_wmt14_de_en_dual-bert-de-en/src_vocab.txt
PRE=/home/valexsyu/Doc/NMT/Reorder_nat/data/nat_position_reorder/awesome/Bibert_token_distill_wmt14_de_en_dual-bert-de-en/tgt_vocab.txt
	    ...
	    for data_type in "${DATA_TYPES[@]}" ; do
			...
			CHECKPOINTS_DATA=checkpoint_$ck_ch.pt
				...
				python generate.py \
					...
					--left-pad-source \
                    --prepend-bos \
					--pretrained-lm-name bert-base-uncased \
					--pretrained-model-name bert-base-uncased \
					--pretrained-embedding-name dbmdz/bert-base-german-uncased \
...
# =========================================================================================================================================
# -----------    Setting    -------------
CHECKPOINTS=("No-1-3-2-reorder-translation" "No-1-3-4-reorder-translation-lm")
REORDER_TRANSLATION=reorder_translation
DATA_TYPES=("test")
...
# =========================================================================================================================================
# -----------    Setting    -------------
CHECKPOINTS=("No-1-3-3-translation-lm")
REORDER_TRANSLATION=translation
DATA_TYPES=("test")
