#---------Path Setting-------------------#
CHECKPOINT=checkpoints/No-5-1-003-translation-init-lm
DATA_BIN=data/nat_position_reorder/awesome/Bibert_token_distill_iwslt14_de_en_distill-mbert/de-en-databin
MAX_TOKENS=2048
MAX_EPOCH=400
CUR_START_EPOCH=300
CUDA_DEVICES=0
