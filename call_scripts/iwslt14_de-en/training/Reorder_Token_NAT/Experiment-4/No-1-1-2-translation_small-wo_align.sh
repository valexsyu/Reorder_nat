#---------Path Setting-------------------#
CHECKPOINT=checkpoints/No-1-1-2-translation-small-wo_align
DATA_BIN=data/nat_position_reorder/awesome/Bibert_token_distill_iwslt14_de_en/de-en-databin
MAX_TOKENS=10000
MAX_EPOCH=200
CUR_START_EPOCH=300
CUDA_DEVICES=0,1
...
cat > $CHECKPOINT/temp1.sh << 'endmsg'
    ...
    --wandb-project ReorderNAT4-No-1-1-2 \
    --init-reorder --init-translator \
    --save-interval 1    
#--curricular-learning \
...
#--encoder-causal-attn \
#--wandb-project ReorderNAT3-No-0 \
#--add-blank-symbol \
#--global-token \
#--use-align-position \
#--update-freq 2 \
