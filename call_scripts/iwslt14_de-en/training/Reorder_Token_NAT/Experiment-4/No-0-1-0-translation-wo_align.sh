#---------Path Setting-------------------#
CHECKPOINT=checkpoints/No-0-1-0-translation-wo_align
DATA_BIN=data/nat_position_reorder/awesome/Bibert_tokenize_iwslt14_de_en/de-en-databin
MAX_TOKENS=4000
MAX_EPOCH=200
CUR_START_EPOCH=300
CUDA_DEVICES=0
...
cat > $CHECKPOINT/temp1.sh << 'endmsg'
    ...
    --wandb-project ReorderNAT4-No-0-1-0 \
