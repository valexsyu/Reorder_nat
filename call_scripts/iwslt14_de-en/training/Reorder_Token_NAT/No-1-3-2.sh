#---------Path Setting-------------------#
CHECKPOINT=checkpoints/No-1-3-2 # MSE + Learning rate + iter 3000 + wodis
...
cat > $CHECKPOINT/temp1.sh << 'endmsg'
    ...
    --stop-min-lr '1e-09' --warmup-updates 2 \
    ...
    --wandb-project ReorderNAT3-No-1-3-1 \
    --global-token \
    --iter-num-reorder 3000 \
    --iterative-reorder-translator \
    --save-interval 1    
#--curricular-learning \
