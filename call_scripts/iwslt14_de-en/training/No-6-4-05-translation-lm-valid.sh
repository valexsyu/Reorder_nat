...
conda activate base
#---------Path Setting-------------------#
CHECKPOINT=checkpoints/No-6-4-05-translation-lm-valid
DATA_BIN=data/nat_position_reorder/awesome/Bibert_token_distill_valid-nondistill_iwslt14_de_en_52k/de-en-databin
MAX_TOKENS=2048
MAX_EPOCH=400
CUR_START_EPOCH=300
CUDA_DEVICES=0
