#---------Path Setting-------------------#
CHECKPOINT=checkpoints/No-1-3-4-reorder-translation-lm
DATA_BIN=data/nat_position_reorder/awesome/Bibert_token_distill_iwslt14_de_en_dual-bert-de-en/de-en-databin
MAX_TOKENS=2048
MAX_EPOCH=400
CUR_START_EPOCH=300
CUDA_DEVICES=0
...
cat > $CHECKPOINT/temp1.sh << 'endmsg'
    ...
    --update-freq 6 \
    --max-update 100000 \
    --num-translation-update 50000 \
    --num-reorder-update 25000 \
    --num-reorder-translation-update 25000 \
#--curricular-learning \
