...
TOKEN_PATH=/home/valexsyu/Doc/NMT/Reorder_nat/data/nat_position_reorder/awesome/Bibert_token_distill_iwslt14_de_en_dual-bert-de-en
MODEL_NAME_EN=bert-base-uncased
MODEL_NAME_DE=dbmdz/bert-base-german-uncased
## tokenize translatio
mkdir $TOKEN_PATH
cd /home/valexsyu/Doc/NMT/Reorder_nat/call_scripts/iwslt14_de-en/prepare_data/Bert
