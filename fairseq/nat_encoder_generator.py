...
# DataOut = namedtuple(
#     "NATEncoderGeneratorOut",
#     ["output_tokens", "output_scores", "output_entropys","attn", "step", "max_step", "history"],
# )
DataOut = namedtuple(
    "NATEncoderGeneratorOut",
...
class NATEncoderGenerator(object):
    def __init__(
        self,
        tgt_dict,
        src_dict,
        ...
        self.models = models
        self.add_blank_symbol = add_blank_symbol
        if self.add_blank_symbol :             
    ...
    def generate(self, models, sample, prefix_tokens=None, constraints=None):
        ...
        tgt_tokens = sample["target"] # valex test
        ...
        # def finalized_hypos(step, prev_out_token, prev_out_score, prev_out_entropys, prev_out_attn):
        def finalized_hypos(step, prev_out_token, prev_out_score, prev_out_attn):
            cutoff = prev_out_token.ne(self.pad) & prev_out_token.ne(self.blank_idx)
            ...
            if prev_out_score is None:
                ...
                score = scores.mean()
            # if prev_out_entropys is None:
            #     entropys, entropy = None, None
            # else:
            #     entropys = prev_out_entropys[cutoff]
            ...
            return {
                ...
                "score": score,
                # "positional_entropys": entropys,                
                # "entropy": entropy,
                "hypo_attn": hypo_attn,
                "alignment": alignment,
            }
        decoder_out = model.forward_inference(
            src_tokens, tgt_tokens, src_lengths, alignments
        )
        ...
        # finalized_entropys = decoder_out.output_entropys[terminated]
        finalized_attn = (
            None
