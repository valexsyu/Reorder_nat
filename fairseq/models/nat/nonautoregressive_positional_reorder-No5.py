...
class NATPositionalReorderModel(BaseFairseqModel):
    ...
    def build_model(cls, args, task):
        ...
        if args.pretrained_model_name is not None:
            if args.lm_loss_dis  :
                reorder_encoder = AutoModelForMaskedLM.from_pretrained(args.pretrained_model_name)
                ...
                translator_encoder = AutoModel.from_pretrained(args.pretrained_model_name)
        else:
    ...
    def forward(
        ...
        def get_pretrained_embedding(src_tokens) :
            ...
            token_embeddings = self.pretrained_lm(src_tokens, output_hidden_states=True)[2]
